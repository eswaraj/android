...
import com.jansampark.vashisthg.location.LocationUtils;
...
//                errorFragment.show(getSupportFragmentManager(), LocationUtils.APPTAG);
    ...
    public void getLocation() {
        ...
        if (servicesConnected()) {
            ...
            showMarkerAtPosition(currentLocation);
    ...
    private void showMarkerAtPosition(Location location) {
    	LatLng position = LocationUtils.getLatLng(this, location);
    	gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(position,2));
