...
public class YouTubeVideoHelper {
	...
	public YouTubeVideoHelper(Context context, YouTubeLinkRequestCallback callback) {
	...
	private void putUrlFor(JSONObject jsonObject, Editor editor, String issueId) throws JSONException {
